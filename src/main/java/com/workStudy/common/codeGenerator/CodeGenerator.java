package com.workStudy.common.codeGenerator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //work_study_program
        dsc.setUrl("jdbc:mysql://localhost:3306/work_study_program?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC&rewriteBatchedStatements=true");
        ...
        gc.setAuthor("JZhi");// 作者

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.workStudy.core.project");
//        pc.setModuleName("model名"); 自定义包名
        ...
        String templatePath = "/templates/cg/mapper.xml.ftl";
        //定义文件输出位置
        String path = "/src/main/java/com/workStudy/core/";
        // 自定义输出配置
        ...
        //controller层
        templatePath = "/templates/cg/controller.java.ftl";
        // 自定义配置会被优先输出
        focList.add(new FileOutConfig(templatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 + pc.getModuleName()
                String expand = projectPath + path + "controller";
        ...
        //service层
        templatePath = "/templates/cg/service.java.ftl";
        // 自定义配置会被优先输出
        focList.add(new FileOutConfig(templatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 + pc.getModuleName()
                String expand = projectPath + path + "service";
        ...
        //serviceImpl层
        templatePath = "/templates/cg/serviceImpl.java.ftl";
        // 自定义配置会被优先输出
        focList.add(new FileOutConfig(templatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 + pc.getModuleName()
                String expand = projectPath + path + "service/impl";
        ...
        //mapper层
        templatePath = "/templates/cg/mapper.java.ftl";
        // 自定义配置会被优先输出
        focList.add(new FileOutConfig(templatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 + pc.getModuleName()
                String expand = projectPath + path +"mapper";
        ...
        //entity类
        templatePath = "/templates/cg/entity.java.ftl";
        // 自定义配置会被优先输出
        focList.add(new FileOutConfig(templatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 + pc.getModuleName()
                String expand = projectPath + path + "entity";
